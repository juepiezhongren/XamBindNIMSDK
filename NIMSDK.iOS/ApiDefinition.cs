...
namespace NIMSDK.iOS
{
	...
	[BaseType (typeof(NSObject))]
	interface NIMAudioObject : NIMMessageObject
	{
	...
	delegate void NIMChatroomQueueInfoHandler ([NullAllowed] NSError arg0, [NullAllowed] NSArray arg1);
	...
	delegate void NIMGlobalSearchMessageBlock ([NullAllowed] NSError arg0, [NullAllowed] NSDictionary<NIMSession, NSArray> arg1);
	...
	interface NIMConversationManager
	{
		...
		[Abstract]
		[Export ("allUnreadCount:")]
		nint SetAllUnreadCount (bool notify);
	...
	[BaseType (typeof(NSObject))]
	interface NIMCustomObject : NIMMessageObject
	{
	...
	[BaseType (typeof(NSObject))]
	interface NIMFileObject : NIMMessageObject
	{
		// -(instancetype _Nonnull)initWithSourcePath:(NSString * _Nonnull)sourcePath;
		[Export ("initWithSourcePath:")]
		IntPtr Constructor (string sourcePath);
	...
	[BaseType (typeof(NSObject))]
	interface NIMImageObject : NIMMessageObject
	{
	...
	[BaseType (typeof(NSObject))]
	interface NIMLocationObject : NIMMessageObject
	{
	...
	interface NIMMediaManagerDelegate
	{
		...
		void PlayAudioDidBeganWithError(string filePath, [NullAllowed] NSError error);
		...
		void PlayAudioDidCompletedWithError(string filePath, [NullAllowed] NSError error);
		...
		void RecordAudioDidBeganWithError([NullAllowed] string filePath, [NullAllowed] NSError error);
		...
		void RecordAudioDidCompletedWithError ([NullAllowed] string filePath, [NullAllowed] NSError error);
	...
	[BaseType (typeof(NSObject))]
	interface NIMVideoObject : NIMMessageObject
	{
		// -(instancetype _Nonnull)initWithSourcePath:(NSString * _Nonnull)sourcePath;
		[Export ("initWithSourcePath:")]
		IntPtr Constructor (string sourcePath);
	...
	[BaseType (typeof(NSObject))]
	interface NIMNotificationObject : NIMMessageObject
	{
	...
	[BaseType (typeof(NSObject))]
	interface NIMTipObject : NIMMessageObject
	{
	}

	// @interface NIMRobotObject : NSObject <NIMMessageObject>
	[BaseType (typeof(NSObject))]
	interface NIMRobotObject : NIMMessageObject
	{
	...
	interface NIMSystemNotificationManager
	{
		...
		[Abstract]
		[Export ("allUnreadCount:")]
		nint SetAllUnreadCount ([NullAllowed] NSObject filter);
